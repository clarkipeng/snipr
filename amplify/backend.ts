...
const acceptFriendLambda = backend.acceptFriendRequestFunction.resources.lambda as any;
...
acceptFriendLambda.addEnvironment('FRIEND_REQUEST_TABLE_NAME', tables['FriendRequest'].tableName);
acceptFriendLambda.addEnvironment('FRIENDSHIP_TABLE_NAME', tables['Friendship'].tableName);
acceptFriendLambda.addEnvironment('USER_PROFILE_TABLE_NAME', tables['UserProfile'].tableName);
...
searchUsersLambda.addEnvironment('USER_PROFILE_TABLE_NAME', tables['UserProfile'].tableName);
